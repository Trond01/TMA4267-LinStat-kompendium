...
In this section we present ideas from the note \cite{Tyssedal}. We suppose we have $k$ main factors $x_1,\dots,x_k$ making up a model of the form:
$$
...
\begin{enumerate}
    ...
    \item \term{Lenth's method} / \term{pseudo standard error} \TODO{}
...
\term{confounded} ... estimated effects are the same. this is the joint effect of ...
