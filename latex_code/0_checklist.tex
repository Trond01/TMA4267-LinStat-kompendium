...
\begin{multicols}{3}
    \begin{itemize}
        ...
        \begin{todolist}
            ...
            \item[\done] Lecture 1-25
        \end{todolist}
        \item Gjennomgang
        \begin{todolist}
            \item[\done] Lecture 1-2
            \item[\done] Lecture 3-4
            \item[\done] Lecture 5-6
            \item[\done] Lecture 7-8
            \item[\done] Lecture 9-10 %(minus proof of prop 6)
            \item[\done] Lecture 11-12 %(need to add some R considerations)
            \item[\done] Lecture 13-14 %(minus proofs of F tests)
            \item Lecture 15-16 %(variance stab. trans + box cox ... ) NEED: discussion on visual analysis ++ start of chapter 4

            \item[\done] Lecture 17-18
            \item[\done] Lecture 19-20
            \item[\done] Lecture 21-22
        \end{todolist}
